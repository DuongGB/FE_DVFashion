    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 relative rounded-t-2xl">
          <button
            onClick={onClose}
            className="absolute top-4 right-4 bg-black/20 backdrop-blur-sm text-white rounded-full w-10 h-10 flex items-center justify-center text-xl hover:bg-black/30 transition-all duration-200 cursor-pointer"
          >
            <IconX size={20} />
          </button>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="backdrop-blur-xl bg-white/60 border border-white/30 rounded-xl p-6 shadow-lg">
                ...
                <div className="border-2 border-dashed border-white/50 rounded-lg p-4 bg-white/40 backdrop-blur-sm">
                  ...
                  <div
                    ...
                    } items-center justify-center h-64 bg-white/60 rounded-lg`}
                  >
                    <div className="text-center text-gray-500">
                      <div className="bg-white/70 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                    ...
                    <div className="mt-2">
                      <span
                        className={`inline-flex items-center gap-2 px-3 py-2 rounded-full text-sm font-medium ${
                          category.active
                            ? "bg-green-100/60 text-green-800 border border-green-200/40"
                            : "bg-red-100/60 text-red-800 border border-red-200/40"
                        }`}
                      >
                        {category.active ? (
                          <>
            ...
            <div className="backdrop-blur-xl bg-white/60 border border-white/30 rounded-xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {category.createdAt && (
                  <div className="p-4 bg-green-50/60 rounded-lg border border-green-200/40">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="bg-green-100/60 rounded-full p-1">
                ...
                {category.updatedAt && (
                  <div className="p-4 bg-yellow-50/60 rounded-lg border border-yellow-200/40">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="bg-yellow-100/60 rounded-full p-1">
            ...
            <div className="backdrop-blur-xl bg-white/60 border border-white/30 rounded-xl p-6 shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-3 bg-purple-50/60 rounded-lg border border-purple-200/40">
                ...
                {category.slug && (
                  <div className="p-3 bg-indigo-50/60 rounded-lg border border-indigo-200/40">
              ...
              {category.description && (
                <div className="mt-6 p-4 bg-gradient-to-br from-blue-50/60 to-purple-50/60 rounded-lg border border-blue-200/40">
                  ...
                  <p className="text-gray-700 leading-relaxed whitespace-pre-wrap bg-white/80 p-3 rounded border border-white/30">
                    {category.description}
                  </p>
                </div>
              )}
            ...
            <div className="flex justify-end gap-3 pt-6 border-t border-white/30">
              <button
                onClick={onClose}
                className="px-6 py-2 text-gray-600 backdrop-blur-sm bg-white/70 border border-white/30 rounded-lg hover:bg-white/90 transition-all duration-200 cursor-pointer"
              >
